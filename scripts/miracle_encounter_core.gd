...
## Stubs overridden by MiracleEncounter (subclass). Declared here so Godot 4.7
## can type-check Core before the subclass is resolved.
func _on_state_changed(_miracle_id: String, _new_state: String) -> void:
	pass

func _on_mission_completed(_title: String, _reward: int) -> void:
	pass

func _on_puzzle_opened(_miracle_id: String, _puzzle: Dictionary) -> void:
	pass
...
func _process_clues(_delta: float, _dist: float, _mid: String) -> void:
	pass

func _process_puzzle(_delta: float, _dist: float, _m: Dictionary) -> void:
	pass

func _process_miracle(_delta: float, _dist: float, _mid: String) -> void:
	pass

func _bob_beacon(_delta: float) -> void:
	pass
...
func _tint_beacon(_state: String, _is_major: bool) -> void:
	pass
